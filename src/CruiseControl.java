...
public class CruiseControl {
	...
	public static void main(String[] args) {
		...
		Lever lever = new Lever( analogPort );
		...
		ClutchPedal cp = new ClutchPedal(clutch);
		sim.addListener(cp);
	 ...
	 * Die Funktion enthält den ausgabe String und ein debuglevel. Um so niedriger die Zahl um so wichtiger, 
	 * ist die Information.
